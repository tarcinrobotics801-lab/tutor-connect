...
import { GraduationCap, User, UserCheck, AlertCircle } from "lucide-react";
	...
	const handleSignup = async (e: React.FormEvent) => {
		...
		if (role === "student" && !canStudentRegister) {
			toast({
				...
				description:
					"Student registration is currently unavailable. Please check the requirements.",
				variant: "destructive",
			});
			return;
		}
						...
						>
							<TabsList className="grid w-full grid-cols-3">
								...
								<TabsTrigger value="parent">
									<UserCheck className="h-3 w-3 mr-1" /> Parent
								</TabsTrigger>
							</TabsList>
									...
									<form onSubmit={handleSignup} className="space-y-4">
										<div className="space-y-2">
											...
											<Input
												...
												disabled={
													isLoading ||
													(tabRole === "student" && !canStudentRegister)
												}
											/>
										</div>
										<div className="space-y-2">
							...
							{showStudentRestriction && (
								<Alert className="mt-4">
									...
									<AlertDescription>
										Student registration is currently unavailable. We need at
										least 5 tutors and 4 courses. Current: {tutorCount} tutors,{" "}
										{courseCount} courses.
									</AlertDescription>
								</Alert>
							)}
